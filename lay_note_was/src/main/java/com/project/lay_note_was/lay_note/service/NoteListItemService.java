...
public interface NoteListItemService {
    ...
    ResponseDto<NoteListItemResponseDto> updateNoteListItem(String userEmail, String noteProjectId, Long noteListItemId, NoteListItemRequestDto dto);

    ResponseDto<Void> deleteNoteListItem(String userEmail, Long noteListItemId, String noteProjectId);

    ResponseDto<NoteListItemResponseDto> updateCheck(String userEmail, String noteProjectId, Long noteListItemId, Boolean noteListCheck);
}
